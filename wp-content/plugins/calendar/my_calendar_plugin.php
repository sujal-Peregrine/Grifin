...
function enqueue_fullcalendar_scripts()
{
    ...
    wp_enqueue_script('calendar', plugins_url('calendar.js?q=6', __FILE__), array('jquery'), null, true);
    // Include Toastr CSS
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="dogGender"
                                                            id="not_applicable" value="" checked hidden>
                                                    </div>
                                                </td>
                                            </tr>
...
var endDate = dateRange[1] ? new Date(dateRange[1]) : new Date(startDate); // Use startDate if endDate is not provided
    ...
    if (requiresExtraFields) {
        ...
        if (!dogGender || dogGender.value === '') emptyFields.push('Dog Gender'); // Check if N/A is selected
        if (!numberOfHunters) emptyFields.push('Number of Hunters');
        if (preferredHunt === '' || preferredHunt === 'No Preference') emptyFields.push('Preferred Hunt'); // Check for "No Preference"
